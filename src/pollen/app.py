        ...
        *,
        ...
        if page_title == "Today" and authorization_header is not None:
            ...
            page_content = (
                ...
                f"<li>Materials to buy: {summary['materials_to_buy']} — <a href='/make-buy'>Open buy list</a></li>"
                f"<li>Batches in progress: {summary['batches_in_progress']} — <a href='/make-buy'>Open batches</a></li>"
                f"<li>Purchases due: {summary['purchases_due']} — <a href='/make-buy'>Open purchases</a></li>"
                "</ul></section>"
                "<section><h3>Today actions</h3>"
                "<p>Use these quick actions to continue work in existing workflows.</p>"
                "<ul>"
                "<li><a href='/orders'>Pack and ship orders</a></li>"
                "<li><a href='/products-stock'>Review low-stock products</a></li>"
