...
"</section>"
    ...
    def _render_products_dashboard(
        ...
        *,
        ...
        product_rows = "".join(
            ...
            "</tr>"
            for product in products
        ) or "<tr><td colspan='7'>No finished products yet. Create products in Workshop, then track stock here.</td></tr>"
        material_rows = "".join(
            "<tr>"
    ...
    def _render_make_buy_dashboard(
        ...
        *,
        ...
        product_list = (
            "<table><thead><tr><th>Product</th><th>SKU</th><th>Category</th><th>Selling Price</th><th>Default Batch Size / Yield</th><th>Status</th><th>Recipe</th></tr></thead>"
